...
class SO_Noindex extends SO_Module {
	
	function get_module_title() { return __('Noindex Manager', 'seo-optimization'); }
	function get_module_subtitle() { return __('Noindex', 'seo-optimization'); }
	...
	function init() {
		...
		add_action('so_meta_robots', array(&$this, 'wphead_meta_robots'), 1);
	...
	function get_admin_page_tabs() {
		...
		return array_merge(
			  array(
				  array('title' => __('Default Values', 'seo-optimization'), 'id' => 'so-default-values', 'callback' => 'defaults_tab')
				)
			, $this->get_postmeta_edit_tabs(array(
				  array(
					  'type' => 'checkbox'
					, 'name' => 'meta_robots_noindex'
					, 'label' => __('Noindex', 'seo-optimization')
					)
				, array(
					  'type' => 'checkbox'
					, 'name' => 'meta_robots_nofollow'
					, 'label' => __('Nofollow', 'seo-optimization')
					)
			))
			, $this->get_taxmeta_edit_tabs(array(
				  array(
					...
					, 'name' => 'meta_robots_noindex'
					, 'options' => array(
						  0 => __('Use default', 'seo-optimization')
						, 1 => __('noindex', 'seo-optimization')
						, -1 => __('index', 'seo-optimization')
					)
				...
				, array(
					...
					, 'options' => array(
						  0 => __('Use default', 'seo-optimization')
						, 1 => __('nofollow', 'seo-optimization')
						, -1 => __('follow', 'seo-optimization')
					)
	...
	function defaults_tab() {
		...
		if (!get_option('blog_public'))
			$this->queue_message('error',
				__('Note: The current <a href="options-privacy.php">privacy settings</a> will block indexing of the entire site, regardless of which options are set below.', 'seo-optimization') );
		
		$this->admin_form_table_start();
		$this->admin_form_subheader(__('Prevent indexing of...', 'seo-optimization'));
		$this->checkboxes(array('noindex_admin' => __('Administration back-end pages', 'seo-optimization')
							,	'noindex_author' => __('Author archives', 'seo-optimization')
							,	'noindex_search' => __('Blog search pages', 'seo-optimization')
							,	'noindex_category' => __('Category archives', 'seo-optimization')
							,	'noindex_comments_feed' => __('Comment feeds', 'seo-optimization')
							,	'noindex_cpage' => __('Comment subpages', 'seo-optimization')
							,	'noindex_date' => __('Date-based archives', 'seo-optimization')
							,	'noindex_home_paged' => __('Subpages of the homepage', 'seo-optimization')
							,	'noindex_tag' => __('Tag archives', 'seo-optimization')
							,	'noindex_login' => __('User login/registration pages', 'seo-optimization')
		));
	...
	function postmeta_fields($fields) {
		$fields['30|meta_robots_noindex|meta_robots_nofollow'] = $this->get_postmeta_checkboxes(array(
			  'meta_robots_noindex' => __('Noindex: Tell search engines not to index this webpage.', 'seo-optimization')
			, 'meta_robots_nofollow' => __('Nofollow: Tell search engines not to spider links on this webpage.', 'seo-optimization')
		), __('Meta Robots Tag:', 'seo-optimization'));
