...
class SO_Fofs extends SO_Module {
	function get_module_title() { return __('404 Monitor', 'seo-optimization'); }
...
", 'seo-optimization')));
		...
		$screen->add_help_tab(array(
			  'id' => 'so-fofs-log'
			, 'title' => __('Log Help', 'seo-optimization')
			, 'content' => __("
