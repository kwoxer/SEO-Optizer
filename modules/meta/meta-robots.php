...
class SO_MetaRobots extends SO_Module {
	
	function get_module_title() { return __('Robots.txt Editor', 'seo-optimization'); }
	function get_menu_title()   { return __('Robots.txt', 'seo-optimization'); }
	function get_settings_key() { return 'meta'; }
	
	function init() {
		add_filter('so_meta_robots', array(&$this, 'meta_robots'));
	}
	
	function get_admin_page_tabs() {
		return array(
			array('title' => __('Global', 'seo-optimization'), 'id' => 'so-global', 'callback' => 'global_tab')
		);
	}
	
	function global_tab() {
		$this->admin_form_table_start();
		$this->admin_form_subheader(__('Spider Instructions', 'seo-optimization'));
		$this->checkboxes(array(
				  'noodp' => __('Don&#8217t use this site&#8217s Open Directory description in search results.', 'seo-optimization')
				, 'noydir' => __('Don&#8217t use this site&#8217s Yahoo! Directory description in search results.', 'seo-optimization')
				, 'noarchive' => __('Don&#8217t cache or archive this site.', 'seo-optimization')
			));
...
", 'seo-optimization')));
		...
		$screen->add_help_tab(array(
			  'id' => 'so-meta-robots-troubleshooting'
