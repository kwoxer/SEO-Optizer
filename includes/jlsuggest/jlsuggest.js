jQuery(document).ready( function($) {
	$('input.jlsuggest', '.so-module').each(function() {
		var params = $(this).attr('so:params') ? '&' + $(this).attr('so:params') : '';
		$(this).jlsuggest(ajaxurl + '?action=so-jlsuggest-autocomplete' + params,
